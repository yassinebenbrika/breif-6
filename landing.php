...
<div class="flex items-center justify-between p-4  fixed top-0 left-0 right-0">
  <!-- Search Input -->
  <div class="relative">
    <input type="text" placeholder="Search" class="border-2 border-gray-700 bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
    <div class="absolute top-2 right-3">
      <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m-2-2a7 7 0 1 1-3-3 7 7 0 0 1 3 3 7 7 0 0 1 3-3 7 7 0 1 1-3 3zM4 7a8 8 0 1 0 16 0 8 8 0 0 0-16 0z"></path>
      </svg>
    </div>
  </div>

  <!-- New Project Button -->
  <button class="bg-black text-white py-2 px-4 rounded-full hover:bg-gray-700 focus:outline-none focus:ring focus:border-blue-300">
    New Project
  </button>
</div>
<div id="docs-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-16 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-gray-800 dark:border-gray-700">
  <div class="px-6">
    <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand"><img src="img/screenshot-2023-11-20-172048-result-1-655ba409cbe67121006907-removebg-preview.png" alt="" srcset=""></a>
  </div>
