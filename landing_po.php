...
<body class="bg-gradient-to-tr from-orange-400 via-amber-900 to-blue-500 bg-no-repeat h-fit	">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-between items-center">
                    ...
                    <a href="https://flowbite.com" class="flex mr-4">
                        ...
                        <span
                            class=" hidden md:inline-block  self-center text-2xl font-semibold whitespace-nowrap dark:text-white ">ataWare</span>
                    </a>
                ...
                <button
                    class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-black hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                    <span
    ...
    <div class="flex">
        <aside id="sidebar"
            class=" lg:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-1000	">
