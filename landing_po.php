...
<body class="bg-gradient-to-tr from-orange-400 via-amber-900 to-blue-500 bg-no-repeat h-fit	">
    ...
    <div class="flex">
        <aside id="sidebar"
            class=" lg:flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-10	">
