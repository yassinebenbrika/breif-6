    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                ...
                <span class="mx-4 font-medium">My Project</span>
            </a>
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                ...
                <span class="mx-4 font-medium">My Team</span>
            </a>
    ...
    <div class="flex-1">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="p-6">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Welcome to your dashboard. Here you can find an overview of your projects and tasks.</p>
