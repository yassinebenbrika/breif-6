...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ID'])) {
    ...
    <div class="px-6 py-16 mx-auto text-center">
        <h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-100">Are you sure you want to delete  \'' . $ID . '\'?</h1>
        ...
        <form method="post" action="deleteTeamName.php" class="flex flex-col mt-8 space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2">
